...
| 1   | 28pin DIP Wide IC Socket (optional)    |
...
* Larger EPROMs/EEPROMs can be used, but be sure to repeat the image to fill the ROM up.

## 3D Printable Case
A 3D printable case specifically designed for this PCB is also available. STLs are included in this repo and there is also a [Thingiverse Page](https://www.thingiverse.com/thing:7077905)
